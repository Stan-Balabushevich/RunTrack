package id.slava.nt.core.connectivity.data
...
import id.slava.nt.core.connectivity.domain.DeviceType
    ...
    override fun observeConnectedDevices(localDeviceType: DeviceType): Flow<Set<DeviceNode>> {
        return callbackFlow {
            val remoteCapability = when(localDeviceType) {
                DeviceType.PHONE -> "plrun_wear_app"
                DeviceType.WATCH -> "plrun_phone_app"
            }
            try {
