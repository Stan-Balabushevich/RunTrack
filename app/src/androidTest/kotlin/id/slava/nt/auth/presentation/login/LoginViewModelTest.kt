...
import id.slava.nt.androidtest.SessionStorageFake
import id.slava.nt.androidtest.TestMockEngine
import id.slava.nt.androidtest.loginResponseStub
import id.slava.nt.auth.data.AuthRepositoryImpl
import id.slava.nt.auth.data.EmailPatternValidator
import id.slava.nt.auth.data.LoginRequest
import id.slava.nt.auth.domain.UserDataValidator
import id.slava.nt.core.data.networking.HttpClientFactory
import id.slava.nt.test.MainCoroutineExtension
