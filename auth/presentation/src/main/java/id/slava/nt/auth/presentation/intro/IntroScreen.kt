...
fun IntroScreen(
    ...
    GradientBackground {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.welcome_to_plrun),
                color = MaterialTheme.colorScheme.onBackground,
                fontSize = 20.sp
            )
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = stringResource(id = R.string.plrun_description),
...
private fun PlrunLogoVertical(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.plrun),
            fontSize = 24.sp,
